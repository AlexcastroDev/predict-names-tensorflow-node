...
## Tech Stack
AlexcastroDev/predict-names-tensorflow-node is built on the following main stack:
...
# Tech Stack File
![](https://img.stackshare.io/repo.svg "repo") [AlexcastroDev/predict-names-tensorflow-node](https://github.com/AlexcastroDev/predict-names-tensorflow-node)![](https://img.stackshare.io/public_badge.svg "public")
<br/><br/>
